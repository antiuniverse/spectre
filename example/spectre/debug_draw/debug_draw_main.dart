...
class DebugDrawExample extends Example {
  DebugDrawExample(CanvasElement element) : super('DepthTexture', element);
...
main() {
  var example = new DebugDrawExample(query('#backBuffer'));
